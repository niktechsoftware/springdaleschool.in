								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										...
										<div>	
											<label>
												Select Exam Name
												<select name="exam_name" id="exam_name1" class="form-control">
											...
											<label>
												Class Name
												<select name="classv" id="classv1" class="form-control">
													<option value="01">-Select-</option>
											...
											<label>
												Section
												<select class="form-control" id="sectionId1" name="section" style="width: 130px;"></select>
											</label>
											<label>
												Subject
												<select class="form-control" id="editSubjectId1" name="section" style="width: 220px;"></select>
											</label>
										</div>	
