							...
							<div class="col-sm-12">
								<div class="panel panel-white">
									...
									<div class="panel-body">
										...
										//	echo $fsd;
										$diExam = $this->db->query("SELECT DISTINCT exam_name FROM exam_info WHERE stu_id ='$v' and fsd='2018-04-01'")->result();
										 foreach($diExam as $dExam):?>
								          <div class="alert alert-block alert-success fade in"> <h4 class="alert-heading"><i class="fa fa-check"></i> <?php echo $dExam->exam_name." Exam"; ?> </h4> </div>
								             <?php    $var1 = $dExam->exam_name;
								                $dum=$this->db->query("SELECT * FROM exam_info WHERE stu_id ='$v' and exam_name='$var1' and fsd='2018-04-01' ")->result();
										?>
