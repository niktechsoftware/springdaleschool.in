...
?>		
		...
		<table id="items" align="center"  style="width:100%; margin-top:0px; alignment-adjust:central;">
		  	<tr>
		  		...
		  		<th>Subject</th>
		  		<?php if($fsd!='2015-04-01'){?>
		  		<th  style="width:15%;">
		  		
		  		
		  		<table ><tr><td style="border-left:none;border-right:none;" colspan="2">UT-1</td></tr><tr><td style="border-left:none;border-bottom:none; width:35%;">Marks</td><td style="border-right:none;border-bottom:none; width:35%;">MM</td></tr></table>
		  	</th>
		  		
		  		<th style="width:15%;"><table ><tr><td style="border-left:none;border-right:none;" colspan="2">Half Yearly</td></tr><tr><td style="border-left:none;border-bottom:none; width:35%;">&nbsp;Marks&nbsp;&nbsp;</td><td style="border-right:none;border-bottom:none; width:35%;">&nbsp;&nbsp;&nbsp;MM&nbsp;&nbsp;&nbsp;&nbsp;</td></tr></table>
		  		</th>
		  		<?php }else{ ?>
		  		<th  style="width:15%;">
		  		<table ><tr><td style="border-left:none;border-right:none;" colspan="2">Half Yearly</td></tr><tr><td style="border-left:none;border-bottom:none; width:35%;">Marks</td><td style="border-right:none;border-bottom:none; width:35%;">MM</td></tr></table>
		  	</th>
		  		
		  		<th style="width:15%;"><table ><tr><td style="border-left:none;border-right:none;" colspan="2">Annual</td></tr><tr><td style="border-left:none;border-bottom:none; width:35%;">&nbsp;Marks&nbsp;&nbsp;</td><td style="border-right:none;border-bottom:none; width:35%;">&nbsp;&nbsp;&nbsp;MM&nbsp;&nbsp;&nbsp;&nbsp;</td></tr></table>
		  	...
		  	$per = 0;
		  		...
		  		foreach($var as $row):
		  			...
		  			if((($ex->exam_name=='UT-1') || ($ex->exam_name=='QUARTLY EXAM')) && ($fsd =='2016-04-01')){
		  			...
		  			$this->db->where("created < ",$futureDate);
				  		...
				  		$result = $var1->row();
					  		...
					  		if($num > 0) {
					  			...
					  			if ($result->Attendance=='P')
					  			{
					  				if($result->marks > 9)
					  				{
					  					echo "<td  style='text-align: center;'><table ><tr><td style='border-left:none;border-bottom:none;border-top:none; width:35%;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$result->marks."&nbsp;&nbsp;</td><td style='border-right:none;border-bottom:none;border-top:none; width:35%;'>".$result->out_of."</td></tr></table></td>";
					  				}
						  			else
						  			{
						  			echo "<td  style='text-align: center;'><table ><tr><td style='border-left:none;border-bottom:none;border-top:none; width:35%;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0".$result->marks."&nbsp;&nbsp;</td><td style='border-right:none;border-bottom:none;border-top:none; width:35%;'>".$result->out_of."</td></tr></table></td>";
					  			...
					  			{
					  			echo "<td  style='text-align: center;'><table ><tr><td style='border-left:none;border-bottom:none;border-top:none; width:35%;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AB</td><td style='border-right:none;border-bottom:none;border-top:none; width:35%;'>".$result->out_of."</td></tr></table></td>";
					  			 }
		  				...
		  				if((($ex->exam_name=='Half Yearly') || ($ex->exam_name=='YEARLY EXAM')) && ($fsd =='2015-04-01')){
		  				$this->db->where("created > ",$fsd);
		  				$this->db->where("created < ",$futureDate);
		  	...
		  	<tr>
			  		...
			  		<td><table ><tr><td style="border-left:none;border-bottom:none;border-top:none; width:35%;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tot1;?></td><td style="border-right:none;border-bottom:none;border-top:none; width:35%;">&nbsp;&nbsp;&nbsp;<?php if($gross1 > 9 ){echo $gross1;}else{echo "0".$gross1; }?></td></tr></table>
		  				</td>
