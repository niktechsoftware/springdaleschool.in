			...
			jQuery(document).ready(function() {
				...
				$('input[name="day[]"]').on("click",function(){
					...
					if($('#saturday:checked').val()?true:false)
					{
					 ...
					 $.post("<?php echo site_url('index.php/periodTimeControllers/periodSchedule') ?>",{ monday : monday,tuesday : tuesday,wednesday : wednesday,thursday : thursday,friday : friday,saturday : saturday },function(data){
