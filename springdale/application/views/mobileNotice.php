...
elseif($this->uri->segment(3) == 'Announcement'){ ?>
			<p class="alert alert-info"> <strong>Note : </strong>This is the area you are able to send Announcement to <strong>all Employee and Teacher</strong>. Type the message in textbox and press send.</p>
            <p class="alert alert-danger"> Available SMS Balance = <?php echo $cbs;?></p>
            <?php
...
elseif($this->uri->segment(3) == 'Greeting'){ ?>
			<p class="alert alert-info"> <strong>Note : </strong>This is the area you are able to send Greeting to all Student and Employee and Parents. Type the message in textbox and press send.</p>
             <p class="alert alert-danger"> Available SMS Balance = <?php echo $cbs;?></p>
