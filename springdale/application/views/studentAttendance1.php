		...
		<div class="row">
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									...
									<div class="row">
										<div class="alert alert-warning">Note:- Please Select Date of Attendance for back Attendance otherwise it will take current date.</div>
									<div class="row">
									...
									<div class="row space20">
										...
										<div class="col-sm-3">
											<div class="form-group">
												...
												<div class="col-sm-9">
												<input type="date"  class="form-control" id="date1" name="date1" required="required" placeholder="Text Field">
												</div>
											</div>
										</div>
										<div class="col-sm-3">
