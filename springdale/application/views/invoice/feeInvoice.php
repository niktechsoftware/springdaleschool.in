...
?>		
		...
		<div id="customer">
            ...
            <table> 
                    ...
                    <tr>
                    	<td style="border:none; line-height: 8px;">
                    		Fathers Name : <strong><?php echo $pInfo->father_full_name; ?></strong>
                        </td>
                    </tr>
                    <tr>
                    	<td style="border:none; line-height: 8px;">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="line-height: 8px;"><?php echo $rowc->student_id; $id = $rowc->student_id; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="meta-head" style="line-height: 8px;">Deposit Date</td>
                    <td style="line-height: 8px;">
                    	<?php 
