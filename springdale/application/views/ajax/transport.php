													...
													<?php 
													    ...
													    $rows = $this->db->get("fee_shedule")->row();
																						?><tr>
																					  			...
																					  			<td><input type="text" name ="computer_fee<?php echo $count?>" style="width:60px;" value="<?php if($rows){ echo $rows->Computer_Fee;}else {echo "NA";}?>" id="computer_fee<?php echo $count?>" <?php if(!$rows){?> disabled="disabled" <?php }?>/></td>
																					  			<td><input type="text" name ="examination_fee<?php echo $count?>"  style="width:60px;" value="<?php if($rows){ echo $rows->Exam_Fee;}else {echo "NA";}?>" id="examination_fee<?php echo $count?>" <?php if(!$rows){?> disabled="disabled" <?php }?>/></td>
																					  			<td><input type="text" name ="tranport_fee<?php echo $count?>" style="width:60px;" value="<?php if($rows){ echo $rows->Transport_Fee;}else {echo "NA";}?>" id="tranport_fee<?php echo $count?>" <?php if(!$rows){?> disabled="disabled" <?php }?>/></td>
