...
<!-- ------------------------------------------------- Payment mode Column Start ------------------------------------------------------ -->							
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-white">
                                    ...
                                    <div class="row" id="reason12">
                                        <div class="col-sm-12">
                                            <BR/>
                                            <div class="row space15">
                                                <div class="col-sm-12">
                                                    <div class="col-sm-3">Discount Fee Reason</div>
                                                    <div class="col-sm-9">
                                        ...
                                        <?php
                                            foreach($fields as $field):
                                                ...
                                                ?>
                                                    <div class="row space15">
                                                        <div class="col-sm-12">
                                                            <div class="col-sm-6"> <?php if($field=="Others_Fee"){echo $field; }else {echo $field;}; ?></div>
                                                            <div class="col-sm-6">
                                                                <input type="text" id="<?php if($field == "Games_&_Sports_Fee"){echo "game";
                                                                 ...
                                                                 if(($field == "Exam_Fee")&&($month == 5))
                                                                	...
                                                                	<?php if($is_shedule >= 0 && $field == "Others_Fee"){echo ' required = "required"';} ?> class="form-control"/>
...
<!-- ------------------------------------------------- Payment mode and Fee Detail Column End ------------------------------------------------------ -->		
	...
	$("#form-field-select-2").change(function(){
		...
		foreach($fields as $field): ?>
		<?php if($field != "id" && $field != "student_id" && $field != "finance_start_date" && $field != "Late_Fee"):?>
		...
		if($field == "Late_Fee"){?>
		$("#<?php echo $field; ?>").val(<?php echo $cfees;?>);
		<?php }
		?>
		<?php endforeach; ?>
		var count = 0;
		<?php foreach($fields as $field): ?>
		<?php if($field != "id" && $field != "student_id" && $field != "finance_start_date"):?>
...
$stamp1 = date("Y-m-d");
	...
	<?php foreach($fields as $field): ?>
		...
		if($field != "id" && $field != "student_id" && $field != "finance_start_date" && $field != "Late_Fee" ): ?>
			...
			$("#<?php if($field == "Games_&_Sports_Fee"){echo "game";}else{echo $field;} ?>").keyup(function(){
				...
				<?php if($month == 0):?>
					<?php foreach($fields1 as $field): ?>
						<?php if($field != "id" && $field != "student_id" && $field != "diposit_date" && $field != "finance_start_date"):?>
		...
		if($month == 0):
            ...
            foreach($fields1 as $field):
                ...
                $("#<?php if($field == "Games_&_Sports_Fee"){echo "game";}else{echo $field;} ?>").keyup(function(){
    				...
    				<?php 
    					foreach($fields as $field): 
    						if($field != "id" && $field != "student_id" && $field != "diposit_date" && $field != "finance_start_date" && $field != "Late_Fee"):?>
    							count += Number($("#<?php if($field == "Games_&_Sports_Fee"){echo "game";}else{echo $field;} ?>").val());
    				<?php 
    						endif;
