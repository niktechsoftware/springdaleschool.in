...
<div class="toolbar row">
    ...
    <div class="col-sm-6 col-xs-12">
        ...
        <?php $smsb = checkBalSms();?>
      <button class="btn btn-success">SMS Balence = <?php echo $smsb; ?> </button>
      <?php }?>
...
<div class="row">
    <div class="col-md-12">
        ...
        </ol>  <?php if(($this->session->userdata('login_type') == 'admin') ||($this->session->userdata('login_type') == 'accountent')){?>
        <a href="<?php echo base_url(); ?>index.php/smsAjax/smsPanel">
         <button type="button" class="btn btn-orange">SMS Panel</button></a>
         <a href="<?php echo base_url(); ?>index.php/studentController/studentPanel">
         <button type="button" class="btn btn-purple">Student Panel</button></a>
       <?php } ?>  
    </div>
