							...
							<div class="panel-body">
								<div class="col-sm-12">
									...
									<div class="form-group col-sm-3">
										...
										<div class="col-sm-9">
											<input type="text" data-date-format="yyyy-mm-dd" data-date-viewmode="years" id="sdate" name="startdate" class="form-control date-picker">
										</div>
									</div>
									...
									<div class="form-group col-sm-3">
										...
										<div class="col-sm-9">
											<input type="text" data-date-format="yyyy-mm-dd" data-date-viewmode="years" id="edate" name="enddate" class="form-control date-picker">
										</div>
									</div>
								</div>
