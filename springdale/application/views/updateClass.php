<div class="row">
	<div class="col-md-12">
		<div class="panel panel-white">
			...
			<div class="text-blue text-large"> <strong>Welcome to update class panel </strong> where we can edit and delete class one by one <strong>  make sure that admission 
					...
					<table class="table table-striped table-hover center" id="sample-table-2" style="border:3px solid green;" >
						<thead class="text-blue text-large" style="border:3px solid green;">
							<tr>
								...
								<th style="border:1px solid green;">Subject Stream</th>
