							...
							<div class="col-sm-12">
								<div class="panel panel-white">
									...
									<div class="panel-body">
										...
										<div class="alert alert-success"><h4>Welcome to Examination Section Area, in this page we can enter and save Student marks scored in a particular class and subject <strong>Please select following Dropdown options and wait for another page.</strong> Fill the marks and click save button to save students marks. <strong class="new-note">(Note : if marks are already filled in a class and subject then you can not save or update marks you can only view).</strong></h4> </div>
