...
<script>
	...
	{?>
		$("#classSave<?php echo $j;?>").click(function(){
			var cs = $('#id<?php echo $j;?>').val();
			var name = $('#classSave<?php echo $j;?>').val();
		//	alert("rahul");
			$.post("<?php echo site_url('index.php/employeeController/givenDetail') ?>", {cs : cs,name : name}, function(data){
