		...
		<script>
			jQuery(document).ready(function() {
				...
				$("#sectionId").change(function(){
					...
					var date1 = $("#date1").val();
					var teacherid = $("#teacherid").val();
				$.post("<?php echo site_url("index.php/teacherController/presentiH") ?>",{section : section,date1 : date1,classv : classv}, function(data){
						$("#sample_rahul1").html(data);
						});
				$.post("<?php echo site_url("index.php/teacherController/presenti") ?>",{section : section,classv : classv,date1 : date1,teacherid : teacherid}, function(data){
...
//for attendance 2
			$("#classva2").change(function(){
				...
				$("#sectionIda2").change(function(){
					...
					var date1 = $("#date1").val();
					var teacherid = $("#teacherid").val();
				$.post("<?php echo site_url("index.php/teacherController/presentiHa2") ?>",{section : section,date1 : date1,classv : classv}, function(data){
						$("#sample_rahul1").html(data);
						});
				$.post("<?php echo site_url("index.php/teacherController/presentia2") ?>",{section : section,classv : classv,date1 : date1,teacherid : teacherid}, function(data){
					$("#sample_rahul").html(data);
					});
				$("#sonu").show();
					});
