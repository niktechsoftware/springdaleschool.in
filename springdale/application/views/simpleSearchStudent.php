						...
						<div class="table-responsive">
							<table class="table table-striped table-hover" id="sample-table-2">
								...
								<tbody>
									...
									<tr>
										<td><?php echo $sno; ?></td>
										<td><a href="<?php echo base_url(); ?>index.php/studentController/invoice/<?php echo $row->student_id; ?>"><?php echo $row->student_id; ?></a></td>
										...
										<a href="<?php echo base_url(); ?>index.php/studentController/deleteStudent/<?php echo $row->student_id;?>">Delete</a></td>
									<?php }?>
									</tr>
									<?php $sno++; endforeach; ?>
								</tbody>
