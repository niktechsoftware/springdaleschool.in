...
{  
$url="http://bulksms.niktechsoftware.com/vendorsms/pushsms.aspx?user=spring&password=azamgarh@123&msisdn=".$number."&sid=SDSAZM&msg=".urlencode($msg)."&fl=0&gwid=2";
...
{ 
$url = "http://bulksms.niktechsoftware.com/vendorsms/CheckBalance.aspx?user=spring&password=azamgarh@123";
$ch = curl_init();
curl_setopt($ch,CURLOPT_URL,$url);
curl_setopt($ch,CURLOPT_RETURNTRANSFER,true);
$output=curl_exec($ch);
